...
namespace CustomHelper
{
    static public class TypeStuff
    {
        ...
        //public static ILookupData LookupValues { get; set; }
        ...
        public static void InitializeProxyTypes()
        {
            ...
            foreach (Assembly assembly in AppDomain.CurrentDomain.GetAssemblies())
                ...
                {
                    if (type.FullName.StartsWith("WPFEventInter"))
                    {
                        ...
                        if (customAttributes != null && customAttributes.Length > 0)
                        {
                            ...
                            //TODO Add proxy properties to the object
                            //create object's proxy properties
                            //MethodInfo mi = type.GetMethod("AddProxyObject", BindingFlags.Public | BindingFlags.Static | BindingFlags.FlattenHierarchy);//.Invoke(null, null); 
                            //mi.Invoke(null, new object[] { assocClass.ProxyType }); 
                        }
                    }
                }
